...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="${initParam.hostURL}${pageContext.request.contextPath}/index.jsp">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${initParam.hostURL}${pageContext.request.contextPath}/Category/listCategory.jsp">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <c:if test="${sessionScope.authorized_user.decentral_id eq 1}">
                     <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a class="nav-link" href="${initParam.hostURL}${pageContext.request.contextPath}/Category/addCategory.jsp">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
