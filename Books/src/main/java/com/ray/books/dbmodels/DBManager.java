...
public class DBManager {
	...
	com.ray.books.dbmodels.IConnectionBehavior _cb = null;
	
	public DBManager() { }
	
	public DBManager(com.ray.books.dbmodels.IConnectionBehavior conBehavior) {
	...
	public String getTablesSchemaQuery() {
		return _cb.getTablesSchemaQuery();
	}
}
